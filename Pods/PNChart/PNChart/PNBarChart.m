...
- (void)setupDefaultValues
{
    ...
    _showLabel           = YES;
    _barBackgroundColor  = [UIColor colorWithWhite:0.929 alpha:1.000];
...
- (void)__addYCoordinateLabelsValues{
  ...
  for (int i = 0; i <= _yLabelSum; i++) {
    ...
    label.text = self.yLabels[i];
      
    [self addSubview:label];
      
    label.frame = (CGRect){0, sectionHeight * i + _chartMarginTop - kYLabelHeight/2.0, _yChartLabelWidth + 10, kYLabelHeight + 5};
                ...
                if (_barWidth) {
                    ...
                    if (_showLabel) {
                        ...
                        if (barWidth > 18) {
                            ...
                            barWidth = 18;
                            barXPosition = barXPosition + ( _xLabelWidth * 0.5 * 0.5 - 9);
                        }
