...
- (void)selectIndex:(NSInteger)index
{
    ...
    [self tableView:self.leftTableView didSelectRowAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0]];
...
- (void)animateLeftTableView:(UITableView *)leftTableView rightTableView:(UITableView *)rightTableView show:(BOOL)show complete:(void(^)())complete {
    ...
    if (show) {
        ...
        if (leftTableView) {
            ...
            leftTableView.frame = CGRectMake(_origin.x, self.frame.origin.y + self.frame.size.height, _width, 0);
        ...
        [UIView animateWithDuration:0.2 animations:^{
            if (leftTableView) {
                leftTableView.frame = CGRectMake(_origin.x, self.frame.origin.y + self.frame.size.height,_width, tableViewHeight);
            }
